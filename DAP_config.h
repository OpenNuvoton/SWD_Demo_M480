...
#include "NuMicro.h"                            // Debug Unit Cortex-M Processor Header File
#include "SWDLib.h"
...
{
    GPIO_SetMode(PIN_nRESET_PORT, (1 << PIN_nRESET_BIT), GPIO_MODE_OUTPUT);
    PIN_nRESET_GPIO = 1;
}
...
{
    SWD_Close();
    GPIO_SetMode(PIN_nRESET_PORT, (1 << PIN_nRESET_BIT), GPIO_MODE_INPUT);
}
